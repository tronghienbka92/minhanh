        ...
        public virtual void ExportDTTongHopToXlsx(Stream stream, List<ListDoanhThuTongHop> DTTongHop, DateTime TuNgay, DateTime DenNgay)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var item in DTTongHop)
                {
                    ...
                    worksheet.Cells[row, col].Value = item.DT_HA_NOI.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DT_HA_NOI.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DT_HA_NOI.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DT_THAI_NGUYEN.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DT_THAI_NGUYEN.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DT_THAI_NGUYEN.ThanhTien.ToString("###,###");
                    col++;


                    decimal Tong = item.DT_HA_NOI.ThanhTien + item.DT_THAI_NGUYEN.ThanhTien;
                ...
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_HA_NOI.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_HA_NOI.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_HA_NOI.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_THAI_NGUYEN.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_THAI_NGUYEN.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DT_THAI_NGUYEN.ThanhTien).ToString("###,###");
                coltong++;
